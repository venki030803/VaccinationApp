...
public class LoginActivity extends AppCompatActivity {
    ...
    private String URL="http://192.168.252.147:80/medicalproject/parentlogin.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_login);
        Button bt1 = findViewById(R.id.signin1);


        uid = findViewById(R.id.parentidtb);
        upassword=findViewById(R.id.parentpassid);
        ...
        ImageView imageView4 = findViewById(R.id.imageView13);
...
// Set OnClickListener for ImageView 4
        imageView4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(LoginActivity.this, ParentDoctorloginActivity.class);
