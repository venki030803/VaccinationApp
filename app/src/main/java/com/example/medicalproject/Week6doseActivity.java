...
public class Week6doseActivity extends AppCompatActivity {
    String mdate;

    private String URL= ip.ipt +"week6err.php";
    private String username;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_week6dose);
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(Week6doseActivity.this, week6qaActivity.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"week6doseshow.php";
    ...
    private void handleResponse(String response) {
        ...
        if (values[4].equals("1")) {
            ...
            Drawable[] drawables1 = t5.getCompoundDrawables();
            ...
            t5.setCompoundDrawablesWithIntrinsicBounds(drawables1[0], drawables1[1], drawables1[2], drawables1[3]);


        }
        System.out.println(values[4]);
        if (values[5].substring(0, values[5].length() - 1).equals("1")) {
    ...
    private void fetchcom1(String username) {
        // Replace "http://192.168.156.100:80/login/prof.php" with your actual API endpoint
        String apiUrl = ip.ipt + "completed.php";
    ...
    private void handleResponses(String response,String username) {
        ...
        Log.d("JSON Response", response);
        String[] values = response.split(", ");
        if(values[1].substring(0, values[1].length() - 1).equals("0")){
            ...
            if(days>0){
                Dialog myDialog = new Dialog(Week6doseActivity.this);

                myDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
                myDialog.setContentView(R.layout.activity_calenderpopup);

                TextView t2= myDialog.findViewById(R.id.textView50);
                ...
                Intent it1 = new Intent(this,calender.class);
                it1.putExtra("username",username);
                startActivity(it1);
            }
    ...
    private void handleResponses1(String response) {
        ...
        if(values[1].substring(0, values[1].length() - 1).equals("0")){
            ...
            if (calendar != null) {
                ...
                calendar.setLongClickable(false);
                calendar.setDate(getConstantDateMillis());
            }
        }
        else{
            Dialog myDialog = new Dialog(Week6doseActivity.this);
