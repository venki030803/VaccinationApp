...
public class calender_14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calender14);
    ...
    private void sendLoginRequest(final String username,final String date) {
        String URL = ip.ipt+"completed_date_14.php";
    ...
    private void handleResponse1(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(calender_14.this, ScheduleActivity.class);
