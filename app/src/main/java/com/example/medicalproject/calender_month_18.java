...
public class calender_month_18 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calender_month18);
    ...
    private void sendLoginRequest(final String username,final String date) {
        String URL = ip.ipt+"completed_date_month_18.php";
    ...
    private void handleResponse1(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(calender_month_18.this, ScheduleActivity.class);
