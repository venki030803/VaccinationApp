...
public class calender_year_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calender_year3);
    ...
    private void sendLoginRequest(final String username,final String date) {
        String URL = ip.ipt+"completed_date_year_3.php";
    ...
    private void handleResponse1(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(calender_year_3.this, ScheduleActivity.class);
