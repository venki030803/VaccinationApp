...
public class calender_year_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calender_year4);
    ...
    private void sendLoginRequest(final String username,final String date) {
        String URL = ip.ipt+"completed_date_year_4.php";
    ...
    private void handleResponse1(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(calender_year_4.this, ScheduleActivity.class);
