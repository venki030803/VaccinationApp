...
public class docmonth15 extends AppCompatActivity {

    String mdate;
    private int q1=0,q2=0,q3=0;
    private String URL= ip.ipt +"month15dose.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_docmonth15);
        ...
        im2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog myDialog = new Dialog(docmonth15.this);
    ...
    private void sendLoginRequest(final String username) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                System.out.println(username+" "+String.valueOf(q1)+" "+String.valueOf(q2));
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(docmonth15.this, PatientLoginActivity.class);
