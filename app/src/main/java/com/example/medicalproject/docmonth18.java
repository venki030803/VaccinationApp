...
public class docmonth18 extends AppCompatActivity {

    String mdate;
    private int q1=0,q2=0,q3=0,q4=0,q5=0;
    private String URL= ip.ipt +"month18dose.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_docmonth18);
        ...
        im2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog myDialog = new Dialog(docmonth18.this);
    ...
    private void sendLoginRequest(final String username) {
        ...
        String URL = ip.ipt + "month18dose.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                System.out.println(username + " " + String.valueOf(q1) + " " + String.valueOf(q2) + " " + String.valueOf(q3) + " " + String.valueOf(q4) + " " + String.valueOf(q5));
    ...
    private void handleResponse(String response, String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(docmonth18.this, PatientLoginActivity.class);
