...
public class docmonth18qa5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_docmonth18qa5);
        ...
        t1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (username.isEmpty() || cmt.isEmpty() || cmt2.isEmpty() || cmt3.isEmpty()|| cmt4.isEmpty()|| cmt5.isEmpty() ) {
                    Toast.makeText(docmonth18qa5.this, "Fields cannot be empty", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(docmonth18qa5.this, ScheduleActivity.class);
