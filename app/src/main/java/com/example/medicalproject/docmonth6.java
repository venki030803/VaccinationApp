...
public class docmonth6 extends AppCompatActivity {

    String mdate;
    private int q1=0,q2=0,q3=0;
    private String URL= ip.ipt +"month6dose.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_docmonth6);
        ...
        TextView t2= findViewById(R.id.textView43);
        ...
        TextView t3= findViewById(R.id.textView46);
        ...
        im2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog myDialog = new Dialog(docmonth6.this);
        ...
        tt1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, month6qaActivity.class);
    ...
    private void sendLoginRequest(final String username) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                System.out.println(username+" "+String.valueOf(q1)+" "+String.valueOf(q2)+" "+String.valueOf(q3));
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(docmonth6.this, PatientLoginActivity.class);
