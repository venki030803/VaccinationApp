...
public class docweek14dose extends AppCompatActivity {

    String mdate;
    private int q1 = 0, q2 = 0, q3 = 0, q4 = 0, q5 = 0, q6 = 0;
    private String URL = ip.ipt + "week14dose.php";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_docweek14dose);
        ...
        im2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog myDialog = new Dialog(docweek14dose.this);
        ...
        tt1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, week14qaActivity.class);
    ...
    private void sendLoginRequest(final String username) {
        ...
        String URL = ip.ipt + "week14dose.php";
    ...
    private void handleResponse(String response, String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(docweek14dose.this, PatientLoginActivity.class);
