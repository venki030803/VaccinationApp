...
public class docweek14qa3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_docweek14qa3);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, docweek14qa4.class);
    ...
    private void fetchData(String username) {
        String apiUrl = ip.ipt + "week14show_3.php";
