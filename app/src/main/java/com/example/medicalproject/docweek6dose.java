...
public class docweek6dose extends AppCompatActivity {

    String mdate;
    private int q1=0,q2=0,q3=0,q4=0,q5=0,q6=0;
    private String URL= ip.ipt +"week6dose.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_docweek6dose);
        ...
        Drawable[] drawables1 = t1.getCompoundDrawables();

        Drawable newDrawable1 = getDrawable(R.drawable.tickimg);
        newDrawable.setBounds(0, 0, newDrawable1.getIntrinsicWidth(), newDrawable1.getIntrinsicHeight());
        ...
        Drawable[] drawables4 = t1.getCompoundDrawables();

        Drawable newDrawable4 = getDrawable(R.drawable.tickimg);
        newDrawable.setBounds(0, 0, newDrawable1.getIntrinsicWidth(), newDrawable1.getIntrinsicHeight());

        drawables4[2] = newDrawable1;
        t5.setOnClickListener(v -> {
            t5.setCompoundDrawablesWithIntrinsicBounds(drawables4[0], drawables4[1], drawables4[2], drawables4[3]);
            q5=1;
        });
        ...
        im2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog myDialog = new Dialog(docweek6dose.this);
        ...
        tt1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, PatientLoginActivity.class);
            it1.putExtra("username",username);
            it1.putExtra("parentname",parentname);
            startActivity(it1);
        });
    ...
    private void sendLoginRequest(final String username) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                System.out.println(username+" "+String.valueOf(q1)+" "+String.valueOf(q2)+" "+String.valueOf(q3)+" "+String.valueOf(q4)+" "+String.valueOf(q5)+" "+String.valueOf(q6));
                ...
                data.put("q5", String.valueOf(q5));
                data.put("q6", String.valueOf(q6));
                return data;
            }
        };
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(docweek6dose.this, PatientLoginActivity.class);
