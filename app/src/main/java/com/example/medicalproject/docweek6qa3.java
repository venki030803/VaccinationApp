...
public class docweek6qa3 extends AppCompatActivity {
    Button bt3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_docweek6qa3);
        ...
        t1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (username.isEmpty() || cmt.isEmpty() || cmt2.isEmpty() || cmt3.isEmpty() ) {
                    Toast.makeText(docweek6qa3.this, "Fields cannot be empty", Toast.LENGTH_SHORT).show();
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(docweek6qa3.this, ScheduleActivity.class);
