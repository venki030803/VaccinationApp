...
public class docweek7qa3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_docweek7qa3);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, docweek7qa4.class);
    ...
    private void fetchData(String username) {
        String apiUrl = ip.ipt + "week7show_3.php";
