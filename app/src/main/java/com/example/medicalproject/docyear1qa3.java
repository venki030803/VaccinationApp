...
public class docyear1qa3 extends AppCompatActivity {
    String cmt, cmt2="0", cmt3 = "0"; // Initialize cmt2 with a default value
    private Button bt3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_docyear1qa3);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, docyear1qa4.class);
    ...
    private void fetchData(String username) {
        String apiUrl = ip.ipt + "year1show_3.php";
