...
public class docyear4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_docyear4);
        ...
        im2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Dialog myDialog = new Dialog(docyear4.this);
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(docyear4.this, PatientLoginActivity.class);
