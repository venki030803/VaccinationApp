...
public class docyear5qa3 extends AppCompatActivity {
    String cmt, cmt2="0", cmt3 = "0"; // Initialize cmt2 with a default value
    private Button bt3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_docyear5qa3);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, docyear5qa4.class);
    ...
    private void fetchData(String username) {
        String apiUrl = ip.ipt + "year5show_3.php";
