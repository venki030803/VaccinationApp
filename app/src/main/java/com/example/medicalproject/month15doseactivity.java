...
public class month15doseactivity extends AppCompatActivity {

    String mdate;
    private String URL= ip.ipt +"month15err.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_month15doseactivity);
        ...
        tt1.setOnClickListener(view -> {
            Intent it1 = new Intent(this,month15qaActivity.class);
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(month15doseactivity.this, month15qaActivity.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"month15doseshow.php";
    ...
    private void handleResponse(String response) {
        ...
        if (values[1]. substring(0,values[1]. length()-1).equals("1")) {
    ...
    private void fetchcom1(String username) {
        // Replace "http://192.168.156.100:80/login/prof.php" with your actual API endpoint
        String apiUrl = ip.ipt + "completedmonth15.php";
    ...
    private void handleResponses(String response,String username) {
        ...
        if(values[1].equals("0")){
            Dialog myDialog = new Dialog(month15doseactivity.this);
            ...
            Intent it1 = new Intent(this,calender_month_15.class);
            it1.putExtra("username",username);
            startActivity(it1);
        }
        else{
