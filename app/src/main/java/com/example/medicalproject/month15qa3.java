...
public class month15qa3 extends AppCompatActivity {

    String cmt3,cmt,cmt2;
    Button bt3;
    private String URL= ip.ipt +"month15.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_month15qa3);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(month15qa3.this);
        ...
        t1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (username.isEmpty() || cmt.isEmpty() || cmt2.isEmpty() || cmt3.isEmpty() ) {
                    Toast.makeText(month15qa3.this, "Fields cannot be empty", Toast.LENGTH_SHORT).show();
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(month15qa3.this, ScheduleActivity.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"month15show_3.php";
