...
public class month15qaActivity extends AppCompatActivity {
    String cmt = " ";
    private Button bt3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_month15qa);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(month15qaActivity.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, month15qa2.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"month15show.php";
