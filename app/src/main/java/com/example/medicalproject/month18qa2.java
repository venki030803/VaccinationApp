...
public class month18qa2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_month18qa2);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(month18qa2.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, month18qa3.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"month18show_2.php";
