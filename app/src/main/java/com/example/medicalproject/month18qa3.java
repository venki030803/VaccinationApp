...
public class month18qa3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_month18qa3);
        ...
        bt4.setOnClickListener(view -> {
            Dialog myDialog = new Dialog(month18qa3.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, month18qa4.class);
