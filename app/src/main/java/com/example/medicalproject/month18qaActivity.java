...
public class month18qaActivity extends AppCompatActivity {
    String cmt = " ";
    private Button bt3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_month18qa);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(month18qaActivity.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, month18qa2.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt + "month18show.php";
