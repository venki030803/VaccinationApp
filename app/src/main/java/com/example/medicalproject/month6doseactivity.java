...
public class month6doseactivity extends AppCompatActivity {

    String mdate;
    private String URL= ip.ipt +"month6err.php";
    private String username;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_month6doseactivity);
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(month6doseactivity.this, month6qaActivity.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"month6doseshow.php";
    ...
    private void handleResponse(String response) {
        ...
        if (values[2].substring(0,values[2].length()-1).equals("1")) {
    ...
    private void fetchcom1(String username) {
        // Replace "http://192.168.156.100:80/login/prof.php" with your actual API endpoint
        String apiUrl = ip.ipt + "completedmonth6.php";
    ...
    private void handleResponses(String response,String username) {
        ...
        if(values[1].equals("0")){
            Dialog myDialog = new Dialog(month6doseactivity.this);
            ...
            Intent it1 = new Intent(this,calender_month_6.class);
            it1.putExtra("username",username);
            startActivity(it1);
        }
        else{
