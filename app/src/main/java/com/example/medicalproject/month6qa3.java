...
public class month6qa3 extends AppCompatActivity {
    String cmt, cmt2=" ", cmt3 = " "; // Initialize cmt2 with a default value
    private Button bt3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_month6qa3);
        ...
        bt4.setOnClickListener(view -> {
            Dialog myDialog = new Dialog(month6qa3.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, month6qa4.class);
