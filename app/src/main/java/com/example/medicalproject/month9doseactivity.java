...
public class month9doseactivity extends AppCompatActivity {

    String mdate;
    private String URL= ip.ipt +"month9err.php";
    private String username;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_month9doseactivity);
        ...
        tt1.setOnClickListener(view -> {
            Intent it1 = new Intent(this,month9qaActivity.class);
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(month9doseactivity.this, month9qaActivity.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"month9doseshow.php";
    ...
    private void fetchcom1(String username) {
        // Replace "http://192.168.156.100:80/login/prof.php" with your actual API endpoint
        String apiUrl = ip.ipt + "completedmonth9.php";
    ...
    private void handleResponses(String response,String username) {
        ...
        if(values[1].equals("0")){
            Dialog myDialog = new Dialog(month9doseactivity.this);
            ...
            Intent it1 = new Intent(this,calender_month_9.class);
            it1.putExtra("username",username);
            startActivity(it1);
        }
        else{
