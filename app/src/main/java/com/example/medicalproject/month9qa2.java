...
public class month9qa2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_month9qa2);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(month9qa2.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, month9qa3.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"month9show_2.php";
