...
public class month9qa4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_month9qa4);
        ...
        bt4.setOnClickListener(view -> {
            Dialog myDialog = new Dialog(month9qa4.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, month9qa5.class);
    ...
    private void fetchData(String username) {
        String apiUrl = ip.ipt + "month9show_4.php";
