...
public class month9qaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_month9qa);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(month9qaActivity.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, month9qa2.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt + "month9show.php";
