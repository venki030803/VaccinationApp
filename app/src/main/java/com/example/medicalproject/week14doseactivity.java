...
public class week14doseactivity extends AppCompatActivity {

    String mdate;

    private String URL = ip.ipt + "week14err.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_week14doseactivity);
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(week14doseactivity.this, week14qaActivity.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"week14doseshow.php";
    ...
    private void fetchcom1(String username) {
        // Replace "http://192.168.156.100:80/login/prof.php" with your actual API endpoint
        String apiUrl = ip.ipt + "completedweek14.php";
    ...
    private void handleResponses(String response,String username) {
        ...
        if(values[1].equals("0")){
            Dialog myDialog = new Dialog(week14doseactivity.this);
            ...
            if(days>0){
                ...
                Intent it1 = new Intent(this,calender_14.class);
                it1.putExtra("username",username);
                startActivity(it1);
            }
        }
