...
public class week14qa3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_week14qa3);
        ...
        bt4.setOnClickListener(view -> {
            Dialog myDialog = new Dialog(week14qa3.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, week14qa4.class);
