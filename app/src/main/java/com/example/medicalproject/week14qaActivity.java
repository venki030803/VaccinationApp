...
public class week14qaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_week14qa);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(week14qaActivity.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, week14qa2.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"week14show.php";
