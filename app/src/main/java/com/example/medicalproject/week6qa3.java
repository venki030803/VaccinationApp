...
public class week6qa3 extends AppCompatActivity {
    String cmt3,cmt,cmt2;
    Button bt3;
    private String URL= ip.ipt +"week6.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_week6qa3);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(week6qa3.this);
        ...
        t1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                System.out.println(username+"vvv"+cmt+"vvv"+cmt2+"vvv"+cmt3);
                if(cmt.isEmpty()){
                    cmt="1";
                }
                if(cmt2.isEmpty()){
                ...
                if (username.isEmpty() || cmt.isEmpty() || cmt2.isEmpty() || cmt3.isEmpty() ) {
                    Toast.makeText(week6qa3.this, "Fields cannot be empty", Toast.LENGTH_SHORT).show();
    ...
    private void sendLoginRequest(final String username) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL,
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                System.out.println(cmt+" "+cmt2+" "+cmt3);
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(week6qa3.this, ScheduleActivity.class);
    ...
    private void fetchData(String username) {
        // Replace "http://192.168.156.100:80/login/prof.php" with your actual API endpoint
            String apiUrl = ip.ipt +"weekshow_3.php";
