...
public class week6qaActivity extends AppCompatActivity {
    String cmt = "";
    private Button bt3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_week6qa);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(week6qaActivity.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, weekqa2.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"week6show.php";
