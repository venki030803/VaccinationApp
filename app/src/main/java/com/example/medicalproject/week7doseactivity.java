...
public class week7doseactivity extends AppCompatActivity {
    String mdate;

    private String URL = ip.ipt + "week7err.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_week7doseactivity);
        ...
        tt1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, week7qaActivity.class);
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(week7doseactivity.this, week7qaActivity.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"week7doseshow.php";
    ...
    private void fetchcom1(String username) {
        // Replace "http://192.168.156.100:80/login/prof.php" with your actual API endpoint
        String apiUrl = ip.ipt + "completedweek7.php";
    ...
    private void handleResponses(String response,String username) {
        ...
        if(values[1].equals("0")){
            Dialog myDialog = new Dialog(week7doseactivity.this);
            ...
            if(days>0){
                ...
                Intent it1 = new Intent(this,calender_7.class);
                it1.putExtra("username",username);
                startActivity(it1);
            }
        }
