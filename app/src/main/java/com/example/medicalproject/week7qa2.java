...
public class week7qa2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_week7qa2);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(week7qa2.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, week7qa3.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"week7show_2.php";
