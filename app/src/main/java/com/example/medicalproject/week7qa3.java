...
public class week7qa3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_week7qa3);
        ...
        bt4.setOnClickListener(view -> {
            Dialog myDialog = new Dialog(week7qa3.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, week7qa4.class);
