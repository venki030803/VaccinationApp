...
public class week7qaActivity extends AppCompatActivity {
    String cmt = " ";
    private Button bt3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_week7qa);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(week7qaActivity.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, week7qa2.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"week7show.php";
