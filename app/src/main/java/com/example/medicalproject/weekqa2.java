...
public class weekqa2 extends AppCompatActivity {
    String cmt ,cmt2 = "";
    private Button bt3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_weekqa2);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(weekqa2.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, week6qa3.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"week6show_2.php";
