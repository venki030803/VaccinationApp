...
public class year1doseactivity extends AppCompatActivity {

    String mdate;
    private String URL= ip.ipt +"year1err.php";
    private String username;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_year1doseactivity);
        ...
        tt1.setOnClickListener(view -> {
            Intent it1 = new Intent(this,year1qaActivity.class);
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(year1doseactivity.this, year1qaActivity.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"year1doseshow.php";
    ...
    private void fetchcom1(String username) {
        // Replace "http://192.168.156.100:80/login/prof.php" with your actual API endpoint
        String apiUrl = ip.ipt + "completedyear1.php";
    ...
    private void handleResponses(String response,String username) {
        ...
        if(values[1].equals("0")){
            Dialog myDialog = new Dialog(year1doseactivity.this);
            ...
            Intent it1 = new Intent(this,calender_year_1.class);
            it1.putExtra("username",username);
            startActivity(it1);
        }
        else{
