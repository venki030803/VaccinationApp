...
public class year1qa3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_year1qa3);
        ...
        bt4.setOnClickListener(view -> {
            Dialog myDialog = new Dialog(year1qa3.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, year1qa4.class);
