...
public class year1qa4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_year1qa4);
        ...
        bt4.setOnClickListener(view -> {
            Dialog myDialog = new Dialog(year1qa4.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this,year1qa5.class);
