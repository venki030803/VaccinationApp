...
public class year2qa2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_year2qa2);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(year2qa2.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, year2qa3.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"year2show_2.php";
