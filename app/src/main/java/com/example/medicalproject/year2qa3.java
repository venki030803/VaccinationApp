...
public class year2qa3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_year2qa3);
        ...
        bt4.setOnClickListener(view -> {
            Dialog myDialog = new Dialog(year2qa3.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, year2qa4.class);
