...
public class year2qa4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_year2qa4);
        ...
        bt4.setOnClickListener(view -> {
            Dialog myDialog = new Dialog(year2qa4.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this,year2qa5.class);
    ...
    private void fetchData(String username) {
        String apiUrl = ip.ipt + "year2show_4.php";
