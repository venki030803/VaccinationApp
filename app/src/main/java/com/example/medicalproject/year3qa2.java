...
public class year3qa2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_year3qa2);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(year3qa2.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, year3qa3.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"year3show_2.php";
