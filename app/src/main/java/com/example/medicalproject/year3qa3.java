...
public class year3qa3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_year3qa3);
        ...
        bt4.setOnClickListener(view -> {
            Dialog myDialog = new Dialog(year3qa3.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, year3qa4.class);
