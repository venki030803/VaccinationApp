...
public class year3qa4 extends AppCompatActivity {
    String cmt, cmt2=" ", cmt3 = " ", cmt4= " "; // Initialize cmt2 with a default value
    private Button bt3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_year3qa4);
        ...
        bt4.setOnClickListener(view -> {
            Dialog myDialog = new Dialog(year3qa4.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this,year3qa5.class);
    ...
    private void fetchData(String username) {
        String apiUrl = ip.ipt + "year3show_4.php";
