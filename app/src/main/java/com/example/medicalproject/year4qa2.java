...
public class year4qa2 extends AppCompatActivity {
    String cmt ,cmt2 = " ";
    private Button bt3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_year4qa2);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(year4qa2.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, year4qa3.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"year4show_2.php";
