...
public class year4qa3 extends AppCompatActivity {
    String cmt, cmt2=" ", cmt3 = " "; // Initialize cmt2 with a default value
    private Button bt3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_year4qa3);
        ...
        bt4.setOnClickListener(view -> {
            Dialog myDialog = new Dialog(year4qa3.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, year4qa4.class);
