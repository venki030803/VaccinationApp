...
public class year4qa5 extends AppCompatActivity {
    String cmt4,cmt5,cmt,cmt2,cmt3;
    Button bt3;
    private String URL= ip.ipt +"year4.php";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_year4qa5);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(year4qa5.this);
        ...
        t1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (username.isEmpty() || cmt.isEmpty() || cmt2.isEmpty() || cmt3.isEmpty()|| cmt4.isEmpty()|| cmt5.isEmpty() ) {
                    Toast.makeText(year4qa5.this, "Fields cannot be empty", Toast.LENGTH_SHORT).show();
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(year4qa5.this, ScheduleActivity.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"year4show_5.php";
