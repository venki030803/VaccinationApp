...
public class year4qaActivity extends AppCompatActivity {
    String cmt = " ";
    private Button bt3;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_year4qa);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(year4qaActivity.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, year4qa2.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt + "year4show.php";
