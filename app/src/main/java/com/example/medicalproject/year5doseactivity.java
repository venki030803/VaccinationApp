...
public class year5doseactivity extends AppCompatActivity {

    String mdate;
    private String URL= ip.ipt +"year5err.php";
    private String username;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_year5doseactivity);
    ...
    private void handleResponse(String response,String username) {
        ...
        try {
            ...
            if (response.toLowerCase().contains("success")) {
                ...
                Intent intent = new Intent(year5doseactivity.this, year5qaActivity.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"year5doseshow.php";
    ...
    private void handleResponse(String response) {
        ...
        if (values[3].substring(0, values[3].length() - 1).equals("1")) {
    ...
    private void fetchcom1(String username) {
        // Replace "http://192.168.156.100:80/login/prof.php" with your actual API endpoint
        String apiUrl = ip.ipt + "completedyear5.php";
    ...
    private void handleResponses(String response,String username) {
        ...
        if(values[1].equals("0")){
            Dialog myDialog = new Dialog(year5doseactivity.this);
            ...
            Intent it1 = new Intent(this,calender_year_5.class);
            it1.putExtra("username",username);
            startActivity(it1);
        }
        else{
