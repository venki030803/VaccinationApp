...
public class year5qa2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_year5qa2);
        ...
        bt4.setOnClickListener(view -> {
            ...
            Dialog myDialog = new Dialog(year5qa2.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this, year5qa3.class);
    ...
    private void fetchData(String username) {
        ...
        String apiUrl = ip.ipt +"year5show_2.php";
