...
public class year5qa4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_year5qa4);
        ...
        bt4.setOnClickListener(view -> {
            Dialog myDialog = new Dialog(year5qa4.this);
        ...
        t1.setOnClickListener(view -> {
            Intent it1 = new Intent(this,year5qa5.class);
    ...
    private void fetchData(String username) {
        String apiUrl = ip.ipt + "year5show_4.php";
